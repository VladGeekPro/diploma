...
export default function MenuItemTile({ onAddToCart, ...item }) {
  ...
  return (
    <div className="bg-blue-600 mx-2 p-4 rounded-lg text-center hover:bg-blue-500 shadow-xl hover:shadow-orange-600/80 transition-all flex flex-col items-center justify-between height-full">
      ...
      <p className="text-orange-300 text-sm my-4 h-64">{description}</p>
